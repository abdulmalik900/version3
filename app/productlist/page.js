  ...
  return (
    <>
      ...
      <div className="overflow-x-auto p-2">
        <h1 className="lg:text-2xl sm:text-base md:text-lg font-bold mt-4 mb-4">
          All Mobile List
        </h1>
                  ...
                  <Link href={"Edit/" + product._id}>
                    <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M3.293 14.707a1 1 0 001.414 0L10 8.414l1.293 1.293a1 1 0 001.414-1.414l-2-2a1 1 0 00-1.414 0L9 6.586 3.293 12.293a1 1 0 000 1.414z"
                          clipRule="evenodd"
                        />
                      </svg>
                    </button>
